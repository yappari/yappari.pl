...
Poniżej przedstawiam *przykłady konfiguracji* najbardziej przydatnych appenderów dla biblioteki *log4cxx*:

h3. 1. Standardowe wyjście błędów
...
h3. 2. Plik rotujący się przy zadanym rozmiarze</string>
...
h3. 3. Plik rotujący się raz dziennie
