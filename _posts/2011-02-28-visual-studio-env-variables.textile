...
abstract: Propozycja używania zmiennych środowiskowych w plikach
...
W przypadku używania bibliotek Boost możemy stworzyć dwie zmienne
środowiskowe:

|_. Zmienna środowiskowa |_. Wartość |
...
* pozwolić programistom na instalowanie bibliotek na własnych maszynach
w preferowanym przez nich miejscu.

Powyższe podejście możemy także wykorzystać do używania zewnętrznych narzędzi
(np. Inno Setup, 7-zip) we wszelakich skryptach.

h3. Konfiguracja zmiennych środowiskowych z linii poleceń
