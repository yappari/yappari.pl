...
Wykorzystywane konta mailowe należy zdefiniować w pliku: @/etc/exim4/passwd.client@.

*Uwaga*: w przypadku korzystania z serwera poczty, do którego połączenie nie jest szyfrowane,
wymagane jest zdefiniowanie w pliku @/etc/exim4/exim4.conf.localmacros@
następującego makro:
